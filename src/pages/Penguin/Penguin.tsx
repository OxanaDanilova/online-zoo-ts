          ...
          <div className="information-second-wrapper">
            ...
            >
              ...
              <div className="information-block range">
                ...
                <p className="information-description">
                  Antarctic coasts, the Subantarctic regions
                </p>
              </div>
              ...
              <p className="information-description margin-top-ten">
                Most penguins feed on krill, fish, squid and other forms of sea life which they
                catch with their bills and swallow it whole while swimming. A penguin has a spiny
                tongue and powerful jaws to grip slippery prey.
              </p>
              ...
              <p className="information-description margin-top-ten hide">
                ...
                astonishingly agile. Penguins&apos; swimming looks very similar to birds&apos;
                flight in the air.Within the smooth plumage a layer of air is preserved, ensuring
                buoyancy. The air layer also helps insulate the birds in cold waters. On land,
              ...
              <p className="information-description margin-top-twenty hide">
                ...
                wings with white fronts.A predator looking up from below (such as an orca or a
                leopard seal) has difficulty distinguishing between a white penguin belly and the
              ...
              <p className="information-description margin-top-ten hide">
                ...
                around these islands. Also, though the climate of the Arctic and Antarctic regions
                is similar, there are no penguins found in the Arctic.
              </p>
              <h5 className="information-subtitle general hide">Diet:</h5>
              <p className="information-description margin-top-ten hide">
                Penguins eat krill (a shrimp-like crustacean in the family Euphausiidae), squids,
                and fishes. Various species of penguins have slightly different food preferences,
                which reduce competition among species. (See Appendix for information on diet for
                each species.) The smaller penguin species of the Antarctic and the subantarctic
                primarily feed on krill and squids. Species found farther north tend to eat fishes.
                Adélie penguins feed primarily on small krill, while chinstraps forage for large
                krill. Emperor and king penguins mainly eat fishes and squids.
              </p>
            </div>
