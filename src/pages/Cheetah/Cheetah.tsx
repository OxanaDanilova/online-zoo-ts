          ...
          <div className="information-second-wrapper">
            ...
            >
              ...
              <p className="information-description margin-top-ten">
                ...
                establish much smaller territories in areas with plentiful prey and access to
                females. The cheetah is active during the day, with peaks during dawn and dusk. It
                feeds on small- to medium-sized prey, mostly weighing under 40 kg (88 lb), and
                prefers medium-sized ungulates such as impala, springbok and Thomson&apos;s
                gazelles. The cheetah typically stalks its prey to within 60–70 m (200–230 ft),
                charges towards it, trips it during the chase and bites its throat to suffocate it
                to death. It breeds throughout the year. After a gestation of nearly three months, a
                litter of typically three or four cubs is born. Cheetah cubs are highly vulnerable
                to predation by other large carnivores such as hyenas and lions. They are weaned at
                around four months and are independent by around 20 months of age.
              </p>
              ...
              <p className="information-description margin-top-ten hide">
                ...
                jaguarundi (Herpailurus yagouaroundi). Together, these three species form the Puma
                lineage, one of the eight lineages of the extant felids; the Puma lineage diverged
                from the rest 6.7 mya. The sister group of the Puma lineage is a clade of smaller
                Old World cats that includes the genera Felis, Otocolobus and Prionailurus
              </p>
              ...
              <p className="information-description margin-top-twenty hide">
                Females can have their first litter at two to three years of age. Polyestrous,
                females have an oestrus (&quot;heat&quot;) cycle is 12 days long on average, but it
                can vary from three days to a month.
              </p>

              <h5 className="information-subtitle general hide">Habitat:</h5>
              <p className="information-description margin-top-ten hide">
                Unlike many other felids, among cheetahs, females tend to occupy larger areas
                compared to males. Females typically disperse over large areas in pursuit of prey,
                but they are less nomadic and roam in a smaller area if prey availability in the
                area is high. As such, the size of their home range depends on the distribution of
                prey in a region. In central Namibia, where most prey species are sparsely
                distributed, home ranges average 554–7,063 km2 (214–2,727 sq mi), whereas in the
                woodlands of the Phinda Game Reserve (South Africa), which have plentiful prey, home
                ranges are 34–157 km2 (13–61 sq mi) in size. Cheetahs can travel long stretches
                overland in search of food; a study in the Kalahari Desert recorded an average
                displacement of nearly 11 km (6.8 mi) every day and walking speeds ranged between
                2.5 and 3.8 km/h (1.6 and 2.4 mph).
              </p>
              ...
              <p className="information-description margin-top-ten hide">
                ...
                weigh around 120 kg (260 lb), were found to be the major prey in a study in the
                Phinda Game Reserve. In Namibia cheetahs are the major predators of livestock.
              </p>
              <p className="information-description margin-top-ten hide">
