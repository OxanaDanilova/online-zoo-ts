        ...
        <div className="information-wrapper">
          ...
          <div className="information-second-wrapper">
            ...
            <div className="information-block range">
              ...
              <p className="information-description">
                Range: Central and South America <span>[VIEW MAP]</span>
              </p>
            </div>
            ...
            <p className="information-description margin-top-ten">
              ...
              forelimb. The two groups of sloths are from different, distantly related families, and
              are thought to have evolved their morphology via parallel evolution from terrestrial
              ...
              around 12,000 years ago, along with most large bodied animals in the New World. The
              extinction correlates in time with the arrival of humans, but climate change has also
              been suggested to have contributed. Members of an endemic radiation of Caribbean
              sloths also formerly lived in the Greater Antilles but became extinct after humans
              settled the archipelago in the mid-Holocene, around 6,000 years ago.
            </p>
            ...
            <p className="information-description margin-top-twenty">
              Sloths have very low metabolic rates (less than half of that expected for a mammal of
              their size), and low body temperatures: 30 to 34 °C (86 to 93 °F) when active, and
            ...
            <p className="information-description margin-top-ten">
              ...
              sloths is currently unknown.
            </p>
            <h5 className="information-subtitle general">Habitat:</h5>
            <p className="information-description margin-top-ten">
              Although habitat is limited to the tropical rainforests of Central and South America,
              in that environment sloths are successful. On Barro Colorado Island in Panama, sloths
              have been estimated to constitute 70% of the biomass of arboreal mammals. Four of the
              six living species are currently rated least concern; the maned three-toed sloth
              (Bradypus torquatus), which inhabits Brazil s dwindling Atlantic Forest, is classified
              as `&quot;`vulnerable`&quot;`, while the island-dwelling pygmy three-toed sloth (B.
              pygmaeus) is critically endangered. Sloths`&lsquo;` lower metabolism confines them to
              the tropics and they adopt thermoregulation behaviors of cold-blooded animals such as
              sunning themselves
            </p>
            ...
            <p className="information-description margin-top-ten">
              ...
              consists of the contents of its stomach, and the digestive process can take a month or
              more to complete.
            </p>
