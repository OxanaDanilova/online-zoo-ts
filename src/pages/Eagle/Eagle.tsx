          ...
          <div className="information-second-wrapper">
            ...
            <div className="information-block range">
              ...
              <p className="information-description">
                Range: Eurasia and Africa <span>[VIEW MAP]</span>
              </p>
            </div>
            ...
            <p className="information-description margin-top-ten">
              ...
              branches. They lay two eggs each. While the female incubates them, the male takes care
              of her feeding. The hatched offspring can be seen immediately, and are covered with
              down. The nature of the predator forces the chicks from a young age to fight for their
            ...
            <p className="information-description margin-top-ten">
              ...
              wingspan, a short tail and strong paws. The massive beak and sharp claws are the main
              weapons of this raptor.
            </p>
            <p className="information-description margin-top-twenty">
              ...
              height. The eyeball is large and occupies a lot of space in the skull, so eye mobility
              is low, but the well-developed neck makes up for this <span>disadvantage</span>.
              Eagles use their hearing more for communication than for hunting. The sense of smell
              is poorly developed.
            </p>
            <h5 className="information-subtitle general">Lifestyle and reproduction:</h5>
            <p className="information-description margin-top-ten">
              Eagles choose a mate for life. They build large and strong nests, using branches. They
              lay two eggs each. While the female incubates them, the male takes care of her
              feeding. The hatched offspring can be seen immediately, and are covered with down. The
              nature of the predator forces the chicks from a young age to fight for their survival.
              Often one can observe the larger chick trying to push the younger brother out of the
              nest. Sometimes it may even kill it by fighting for food. In cases where there is
              enough food, several chicks grow in the nests.
            </p>
            ...
            <p className="information-description margin-top-ten">
              ...
              search of prey. As a rule, only killed prey goes as food, carrion rarely makes it into
              their
